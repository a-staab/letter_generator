...
def get_user_info():
    ...
    print """Looks like you're looking to send a message to your senator.
             Let's get started!"""
    ...
    from_address_1 = raw_input("""What's your street address? If you have an
                               apartment code or suite number, leave it out for
                               now: we'll get to it next.""")
    ...
    print """Great! Now, what would you like to say in the body of your
             letter?"""
